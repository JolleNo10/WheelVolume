...
## Downloads
- [WheelVolume-v1.0.3-portable-win-x64.zip](https://github.com/JolleNo10/WheelVolume/releases/download/v1.0.3/WheelVolume-v1.0.3-portable-win-x64.zip): Portable build. No installation and no separate .NET install required.
- [WheelVolume-v1.0.3-win-x64.zip](https://github.com/JolleNo10/WheelVolume/releases/download/v1.0.3/WheelVolume-v1.0.3-win-x64.zip): Smaller build, but requires the .NET 8 Windows Desktop Runtime.
...
```powershell
dotnet publish .\WheelVolume\WheelVolume.csproj -c Release -r win-x64 --self-contained false -p:Version=1.0.3 -p:FileVersion=1.0.3.0 -p:PublishSingleFile=true -p:DebugType=None -p:DebugSymbols=false -o .\release\WheelVolume-win-x64
```
